...
<head>
    ...
    <title>学龄期体检记录列表</title>
</head>
<body>
<table id="schoolRecordTable" class="detailTable" align="center" border="0" width="90%" cellspacing="0" cellpadding="0">
    <thead>
    <tr>
        <th>就诊号</th>
        <th>年龄</th>
...
<script>
    ...
    $(document).ready(function() {
        var dataSource="<?php echo U('LookChild/allCheckRecordList','dateForm=SchoolAge');?>";
        $('#schoolRecordTable').DataTable( {
            "ajax": dataSource,
            "lengthChange":false,
            "searching": false,
            language: {
